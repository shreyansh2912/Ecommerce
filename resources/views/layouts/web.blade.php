...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="./index.html"><img src="{{asset('assets/web/img/logo.png')}}" alt=""></a>
        </div>
            ...
            <div class="col-lg-4 col-md-6 col-sm-7">
                <div class="footer__about">
                    ...
                    <div class="footer__payment">
                        <a href="#"><img src="{{asset('assets/web/img/payment/payment-1.png')}}" alt=""></a>
                        <a href="#"><img src="{{asset('assets/web/img/payment/payment-2.png')}}" alt=""></a>
                        <a href="#"><img src="{{asset('assets/web/img/payment/payment-3.png')}}" alt=""></a>
                        <a href="#"><img src="{{asset('assets/web/img/payment/payment-4.png')}}" alt=""></a>
                        <a href="#"><img src="{{asset('assets/web/img/payment/payment-5.png')}}" alt=""></a>
                    </div>
                </div>
            </div>
